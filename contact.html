	...
	<div id="main-container">
		...
		<div id="page-content">
			...
			<div id="page-header">
				...
				<div class="ken-burns" style="background-image:url(../images/backgrounds/page-header-9.jpg); background-position: center;"></div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<i class="decode-icon-placeholder wow tada"></i>
							<h1>Contactanos</h1>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						...
						<form id="contact-form" name="contact-form" method="post" action="assets/php/send.php">
							<fieldset>
								...
								<button class="btn btn-default btn-outline waves waves-dark" id="submit" type="submit" name="submit" value="">Enviar mensaje <i class="decode-icon-cursor"></i></button>
					...
					<div class="col-md-4">
						...
						<h6 style="font-weight: 600;">Informacion de contacto</h6>
						...
						<div class="widget widget-contact ml-lg-5">
							...
							<ul>
								<li class="address">
									...
									Calle 9 de altamira, Caracas Venezuela <br class="d-block d-md-none d-lg-block"> FL 32771
								</li>
								<li class="phone">
								...
								<li class="email">
									...
									<a href="mailto:office@milothemes.com">contact@redlativ.com</a>
								</li>
							</ul>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="map" data-zoom="15" data-height="585" data-address="Barnes Street, Sanford, FL" data-address-details="Here is our location"></div>
